...
data:<xsl:value-of select="@id"/>
  ...
  <xsl:if test="./ATTRIBUTE[@name='Number of Simultaneous Users'] !=''">bpaas:hasSimultaneousUsers <xsl:value-of select="./ATTRIBUTE[@name='Number of Simultaneous Users']"/> ;</xsl:if> 
